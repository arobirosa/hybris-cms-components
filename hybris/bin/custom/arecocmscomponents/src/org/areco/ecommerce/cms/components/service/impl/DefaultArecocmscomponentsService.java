...
public class DefaultArecocmscomponentsService implements ArecocmscomponentsService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultArecocmscomponentsService.class);
	...
	{
		return DefaultArecocmscomponentsService.class.getResourceAsStream("/arecocmscomponents/sap-hybris-platform.png");
	}
